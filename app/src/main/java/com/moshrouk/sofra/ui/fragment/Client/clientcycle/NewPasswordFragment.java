...
public class NewPasswordFragment extends Fragment {
    ...
    ClientApiServices clientApiServices = getClient().create(ClientApiServices.class); Unbinder unbinder;
    ...
    private void ChangePassword() {
        ...
        clientApiServices.newPassword(validationCode,password,cpassword).enqueue(new Callback<com.moshrouk.sofra.data.model.general.password.newpassword.NewPassword>() {
            @Override
