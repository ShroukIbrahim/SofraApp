 ...
 */
public class REditItemFragment extends Fragment {
    ...
    private RequestBody requestBodyitemid;
    private String itemName, itemImage, itemItemDescription, PreparingTime, itemPrice;
    private int itemId;



    public REditItemFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (bundle != null) {
           ...
           itemItemDescription = bundle.getString("itemDes");
            PreparingTime = bundle.getString("itemPrepTime");
    ...
    private void getItemData() {
        ImageViewExecution.LodeImage(getActivity(),
                itemImage,
                ProductImage, R.drawable.pizzamin);
        productName.setHint(itemName);
        productDec.setHint(itemItemDescription);
        productPrice.setHint(itemPrice);
        productTime.setHint(PreparingTime);
    ...
    private void editItem() {
        ...
        requestBodyitemid = HelperMethod.convertToRequestBody(Integer.toString(itemId));

        restaurantApiServices.updateItem(requestBodyDescription, requestBodyPrice, requestBodyPreparingTime
                , requestBodyName, photoRequestBody,requestBodyitemid, requestBodyApiToken).enqueue(new Callback<RestaurantItems>() {
            @Override
